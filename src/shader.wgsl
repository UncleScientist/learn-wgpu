...
struct VertexOutput {
    ...
    @location(2) world_light_position: vec3<f32>,
    @location(3) world_view_position: vec3<f32>,
...
fn fs_main(in: VertexOutput) -> @location(0) vec4<f32> {
    ...
    let world_normal = object_normal.xyz * 2.0 - 1.0;
    ...
    let specular_strength = pow(max(dot(world_normal, half_dir), 0.0), 4.0);
